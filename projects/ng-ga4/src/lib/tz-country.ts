...
//
// GA4's Measurement Protocol (/mp/collect) does NOT derive geolocation from the
// request's source IP — unlike gtag.js's /g/collect endpoint. To populate the
// Country dimension we must send `user_location.country_id` explicitly. The
// browser time zone (Intl.DateTimeFormat().resolvedOptions().timeZone) is the
// most reliable network-free signal for the user's country.
//
// Derived from the IANA tz database (zone1970.tab). Each canonical zone maps to
// its primary country; a handful of legacy aliases that browsers may still emit
// are included. Zones without a country (UTC, Etc/*, GMT) intentionally have no
// entry so the lookup returns undefined and we omit user_location.
...
const TZ_TO_COUNTRY: Record<string, string> = {
    ...
    'Asia/Chita': 'RU', 'Asia/Colombo': 'LK', 'Asia/Damascus': 'SY', 'Asia/Dhaka': 'BD',
    'Asia/Dili': 'TL', 'Asia/Dubai': 'AE', 'Asia/Dushanbe': 'TJ', 'Asia/Famagusta': 'CY',
    'Asia/Gaza': 'PS', 'Asia/Hebron': 'PS', 'Asia/Ho_Chi_Minh': 'VN', 'Asia/Hong_Kong': 'HK',
    'Asia/Hovd': 'MN', 'Asia/Irkutsk': 'RU', 'Asia/Jakarta': 'ID', 'Asia/Jayapura': 'ID',
    ...
    'Asia/Tomsk': 'RU', 'Asia/Ulaanbaatar': 'MN', 'Asia/Urumqi': 'CN', 'Asia/Ust-Nera': 'RU',
    'Asia/Vientiane': 'LA', 'Asia/Vladivostok': 'RU', 'Asia/Yakutsk': 'RU', 'Asia/Yangon': 'MM',
    ...
    'Europe/Tirane': 'AL', 'Europe/Ulyanovsk': 'RU', 'Europe/Vaduz': 'LI',
    ...
    // Legacy aliases still emitted by some browsers/OSes
    'Asia/Calcutta': 'IN', 'Asia/Katmandu': 'NP', 'Asia/Rangoon': 'MM',
    'Asia/Saigon': 'VN', 'Asia/Istanbul': 'TR', 'Europe/Kiev': 'UA',
    'America/Buenos_Aires': 'AR', 'Asia/Ulan_Bator': 'MN', 'Asia/Macao': 'MO',
    'Pacific/Samoa': 'WS', 'Pacific/Ponape': 'FM',
    'US/Eastern': 'US', 'US/Central': 'US', 'US/Mountain': 'US',
    'US/Pacific': 'US', 'US/Alaska': 'US', 'US/Hawaii': 'US'
};
